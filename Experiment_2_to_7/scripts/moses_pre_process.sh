#!/bin/bash
DATA_DIR=$1
DATA_IN_PATH=$DATA_DIR/shuffled.clean
DATA_OUT_PATH=$DATA_DIR/processed_data
...
perl $CLEAN_SCRIPT -ratio 1.5 $DATA_OUT_PATH/norm.low.remv.tok $src_lang $tgt_lang $DATA_OUT_PATH/opus.clean 2 200
